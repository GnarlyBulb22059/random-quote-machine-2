    ...
    <div className="background" style={{ backgroundColor: randomColor, transition }}>
      <div id="quote-box">
        ...
        <div className="buttons">
          <a href='twitter.com/intent/tweet' id="tweet-quote" target='_blank' style={{
            backgroundColor: randomColor,
            marginRight: "10px",
            transition
          }}><FaTwitter color="white"></FaTwitter></a>
          <a href='tumblr.com/intent/tumblr' id="tweet-quote" target='_blank' style={{
            backgroundColor: randomColor,
            marginRight: "20px",
            transition
          }}><FaTumblr color="white"></FaTumblr></a>
